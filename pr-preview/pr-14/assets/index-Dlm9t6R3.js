var x=Object.defineProperty;var R=e=>{throw TypeError(e)};var O=(e,t,r)=>t in e?x(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var K=(e,t,r)=>O(e,typeof t!="symbol"?t+"":t,r),N=(e,t,r)=>t.has(e)||R("Cannot "+r);var P=(e,t,r)=>(N(e,t,"read from private field"),r?r.call(e):t.get(e)),s=(e,t,r)=>t.has(e)?R("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),h=(e,t,r,p)=>(N(e,t,"write to private field"),p?p.call(e,r):t.set(e,r),r),a=(e,t,r)=>(N(e,t,"access private method"),r);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))p(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const c of o.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&p(c)}).observe(document,{childList:!0,subtree:!0});function r(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function p(n){if(n.ep)return;n.ep=!0;const o=r(n);fetch(n.href,o)}})();const T=`
	:host {
		display: grid;
...
`;function $(){const e=new CSSStyleSheet;return e.replaceSync(T),e}function F(){return Array.from({length:64},(t,r)=>{const p=document.createElement("div");return r*9&8&&p.setAttribute("dark",""),p})}function M({fen:e,reversed:t}){return t?[...Q(e)].reverse():[...Q(e)]}function Q(e){return e.split(" ")[0].replace(/\//g,"").replace(/\d/g,t=>"1".repeat(+t)).slice(0,64)}var b,f,u,k,m;class D{constructor(){s(this,k);s(this,b,F());s(this,f,"8/8/8/8/8/8/8/8");s(this,u,!1)}get html(){return P(this,b)}set fen(t){h(this,f,t),a(this,k,m).call(this)}set flipped(t){h(this,u,t),a(this,k,m).call(this)}}b=new WeakMap,f=new WeakMap,u=new WeakMap,k=new WeakSet,m=function(){M({fen:P(this,f),reversed:P(this,u)}).forEach((t,r)=>isNaN(+t)?P(this,b)[r].setAttribute("is",t):P(this,b)[r].removeAttribute("is"))};var d,l,i,w,y,S;class g extends HTMLElement{constructor(){super();s(this,i);s(this,d,new D);s(this,l);h(this,l,this.attachShadow({mode:"closed"}))}connectedCallback(){a(this,i,w).call(this),a(this,i,y).call(this),a(this,i,S).call(this)}attributeChangedCallback(r,p,n){r==="fen"&&(P(this,d).fen=n),r==="flipped"&&(P(this,d).flipped=n!==null)}}d=new WeakMap,l=new WeakMap,i=new WeakSet,w=function(){P(this,d).html.forEach(r=>P(this,l).appendChild(r))},y=function(){P(this,l).adoptedStyleSheets.push($())},S=function(){if(!(typeof window.webkitConvertPointFromNodeToPage=="function"))return;const p=()=>this.setAttribute("style",`--diagram-webkit-unit: ${this.getBoundingClientRect().width/8}px;`);p(),window.addEventListener("resize",p)},K(g,"observedAttributes",["fen","flipped"]);const z=["Cases","Smart"];function H(e,t){e.forEach(r=>{const p=document.createElement("option");p.textContent=r,t.appendChild(p)})}function W(e){const t=new CSSStyleSheet,r=`Diagram${e}`,p=`./fonts/${r}`,n=`${r}.woff2`;t.insertRule(`@font-face { font-family: "Diagram ${e}"; src: url("${p}/${n}"); font-display: block; }`),document.adoptedStyleSheets.push(t)}function I(e){const t=document.querySelector("#app");let r=`--diagram-font: Diagram ${e};`;e==="Assistant"&&(r+=" --diagram-spacing: -0.4cqw"),t.setAttribute("style",r)}function B(e){W(e),I(e)}function J(e){const t=fetch("https://lichess.org/api/tv/feed"),r=n=>e(n),p=()=>console.log("The stream has completed");t.then(_(r)).then(p)}const _=e=>t=>{const r=t.body.getReader(),p=/\r?\n/,n=new TextDecoder;let o="";const c=()=>r.read().then(({done:v,value:A})=>{if(v)o.length>0&&e(JSON.parse(o));else{const C=n.decode(A,{stream:!0});o+=C;const q=o.split(p);o=q.pop();for(const L of q.filter(E=>E))e(JSON.parse(L));return c()}});return c()},U=["rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 
p1pp1p1p/4k3/1p1NP1q1/2QP1p2/8/PP1B1KPP/n6R w - - 0 15","rnb2b1r/p1Np1p1p/4k3/1p2P1q1/2QP1p2/8/PP1B1KPP/n6R b - - 0 15","rnb2b1r/p1Npkp1p/8/1p2P1q1/2QP1p2/8/PP1B1KPP/n6R w - - 1 16","rnb2b1r/p2pkp1p/8/1p1NP1q1/2QP1p2/8/PP1B1KPP/n6R b - - 2 16","rnb2b1r/p2p1p1p/4k3/1p1NP1q1/2QP1p2/8/PP1B1KPP/n6R w - - 3 17","rnb2b1r/p2p1p1p/4k3/1p2P1q1/2QP1N2/8/PP1B1KPP/n6R b - - 0 17","rnb2b1r/p2pkp1p/8/1p2P1q1/2QP1N2/8/PP1B1KPP/n6R w - - 1 18","rnb2b1r/p2pkp1p/8/1p1NP1q1/2QP4/8/PP1B1KPP/n6R b - - 2 18","rnb1kb1r/p2p1p1p/8/1p1NP1q1/2QP4/8/PP1B1KPP/n6R w - - 3 19","rnQ1kb1r/p2p1p1p/8/1p1NP1q1/3P4/8/PP1B1KPP/n6R b - - 0 19","rnQqkb1r/p2p1p1p/8/1p1NP3/3P4/8/PP1B1KPP/n6R w - - 1 20","rnQqkb1r/p1Np1p1p/8/1p2P3/3P4/8/PP1B1KPP/n6R b - - 2 20","rnQq1b1r/p1Npkp1p/8/1p2P3/3P4/8/PP1B1KPP/n6R w - - 3 21","rnQq1b1r/p1Npkp1p/8/1p2P3/1B1P4/8/PP3KPP/n6R b - - 4 21","rnQq1b1r/p1N1kp1p/3p4/1p2P3/1B1P4/8/PP3KPP/n6R w - - 0 22","rnQq1b1r/p1N1kp1p/3B4/1p2P3/3P4/8/PP3KPP/n6R b - - 0 22","rnQ2b1r/p1N1kp1p/3q4/1p2P3/3P4/8/PP3KPP/n6R w - - 0 23","rn2Qb1r/p1N1kp1p/3q4/1p2P3/3P4/8/PP3KPP/n6R b - - 1 23"];function j(){const{random:e}=Math,t=e(),r=(p,n)=>p+e()*n;return t<.05?r(0,200):t<.1?r(2e3,1e3):t<.35?r(900,600):r(300,600)}const G=e=>new Promise(t=>setTimeout(t,e));async function V(e){for(const t of U)e({d:{fen:t}}),await G(j())}customElements.define("demo-diagram",g);{const e=document.querySelector("#typography");H(z,e),B(e.value),e.addEventListener("change",({target:t})=>B(t.value))}{let t=function(r){document.querySelectorAll("demo-diagram").forEach(p=>r?p.setAttribute("colored","colored"):p.removeAttribute("colored"))};var Y=t;const e=document.querySelector("#colored");t(e.checked),e.addEventListener("change",({target:r})=>t(r.checked))}{let e=function({players:t,isFlipped:r,figure:p}){let[n,o]=p.querySelectorAll(".player");r&&([n,o]=[o,n]),o.classList.remove("accent"),n.classList.add("accent"),o.textContent=t[0].user.name,n.textContent=t[1].user.name};var Z=e;J(({t,d:r})=>{const p=document.querySelector("figure#live"),n=p.querySelector("demo-diagram");if(n.setAttribute("fen",r.fen),t==="featured"){const o=r.orientation==="black";o?n.setAttribute("flipped","flipped"):n.removeAttribute("flipped"),e({...r,isFlipped:o,figure:p})}})}V(({d:e})=>{document.querySelector("figure#bronstein").querySelector("demo-diagram").setAttribute("fen",e.fen)});
